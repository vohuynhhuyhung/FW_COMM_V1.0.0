...
C_SRCS += \
../Dev/ThirdParty/tinyusb/src/portable/template/dcd_template.c \
../Dev/ThirdParty/tinyusb/src/portable/template/hcd_template.c 

OBJS += \
./Dev/ThirdParty/tinyusb/src/portable/template/dcd_template.o \
./Dev/ThirdParty/tinyusb/src/portable/template/hcd_template.o 

C_DEPS += \
./Dev/ThirdParty/tinyusb/src/portable/template/dcd_template.d \
./Dev/ThirdParty/tinyusb/src/portable/template/hcd_template.d 


# Each subdirectory must supply rules for building sources it contributes
Dev/ThirdParty/tinyusb/src/portable/template/%.o Dev/ThirdParty/tinyusb/src/portable/template/%.su Dev/ThirdParty/tinyusb/src/portable/template/%.cyclo: ../Dev/ThirdParty/tinyusb/src/portable/template/%.c Dev/ThirdParty/tinyusb/src/portable/template/subdir.mk
...
clean: clean-Dev-2f-ThirdParty-2f-tinyusb-2f-src-2f-portable-2f-template

clean-Dev-2f-ThirdParty-2f-tinyusb-2f-src-2f-portable-2f-template:
	-$(RM) ./Dev/ThirdParty/tinyusb/src/portable/template/dcd_template.cyclo ./Dev/ThirdParty/tinyusb/src/portable/template/dcd_template.d ./Dev/ThirdParty/tinyusb/src/portable/template/dcd_template.o ./Dev/ThirdParty/tinyusb/src/portable/template/dcd_template.su ./Dev/ThirdParty/tinyusb/src/portable/template/hcd_template.cyclo ./Dev/ThirdParty/tinyusb/src/portable/template/hcd_template.d ./Dev/ThirdParty/tinyusb/src/portable/template/hcd_template.o ./Dev/ThirdParty/tinyusb/src/portable/template/hcd_template.su

.PHONY: clean-Dev-2f-ThirdParty-2f-tinyusb-2f-src-2f-portable-2f-template
