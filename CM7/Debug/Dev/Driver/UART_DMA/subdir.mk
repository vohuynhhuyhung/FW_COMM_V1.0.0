...
C_SRCS += \
../Dev/Driver/UART_DMA/uart_dma_driver.c 

OBJS += \
./Dev/Driver/UART_DMA/uart_dma_driver.o 

C_DEPS += \
./Dev/Driver/UART_DMA/uart_dma_driver.d 


# Each subdirectory must supply rules for building sources it contributes
Dev/Driver/UART_DMA/%.o Dev/Driver/UART_DMA/%.su Dev/Driver/UART_DMA/%.cyclo: ../Dev/Driver/UART_DMA/%.c Dev/Driver/UART_DMA/subdir.mk
...
clean: clean-Dev-2f-Driver-2f-UART_DMA

clean-Dev-2f-Driver-2f-UART_DMA:
	-$(RM) ./Dev/Driver/UART_DMA/uart_dma_driver.cyclo ./Dev/Driver/UART_DMA/uart_dma_driver.d ./Dev/Driver/UART_DMA/uart_dma_driver.o ./Dev/Driver/UART_DMA/uart_dma_driver.su

.PHONY: clean-Dev-2f-Driver-2f-UART_DMA
